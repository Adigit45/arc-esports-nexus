    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-bg overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="p-6 rounded-xl bg-card/30 backdrop-blur-sm border border-border/30 hover:border-primary/30 transition-all duration-300">
          ...
          <div className="p-6 rounded-xl bg-card/30 backdrop-blur-sm border border-border/30 hover:border-secondary/30 transition-all duration-300">
          ...
          <div className="p-6 rounded-xl bg-card/30 backdrop-blur-sm border border-border/30 hover:border-accent/30 transition-all duration-300">
